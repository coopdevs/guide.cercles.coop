...
La primera pregunta ens servirà per realitzar les acreditacions. Començarem indicant a les persones assistents que responguin aquesta pregunta amb la finalitat de coneixer el quorum que participa a la assemblea. Aquesta pregunta sols tindrà una resposta tipus "Confirmo la assistència". **Es demanarà a totes les persones assistents que votin en nom seu i amb el dels possibles vots delegats que tinguin disponibles.**
