...
{% hint style="info" %}
Assumint que ja teniu disponible la [vostra plataforma Decidim](../#com-puc-utilitzar-cercles-coop) i un [sistema de emissió de vídeo](1.-necessitats-tecniques-per-organitzar-i-celebrar-reunions-virtuals.md#reunio) seleccionat. 
{% endhint %}
